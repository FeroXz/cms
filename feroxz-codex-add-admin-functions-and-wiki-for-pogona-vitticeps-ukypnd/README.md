...
- [x] Galerieverwaltung erlaubt je Bild die Wahl des Darstellungsmodus (Cover/Contain) für perfekte Ausschnitte.
- [x] Galerieverwaltung vereinfacht die Bedienung ohne Fokus-Slider und nutzt den gewählten Darstellungsmodus.
- [x] Startseiten-Sektionen lassen sich im Adminbereich pro Bereich aktivieren oder ausblenden.
- [x] Hero- und Highlight-Texte inklusive CTA-Links lassen sich im Texte-Editor vollständig anpassen.
