                ...
                <div class="grid cards" style="grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));">
                    <?php foreach ($galleryImages as $image): ?>
                        <article class="card" style="padding:1rem;">
                            <div style="position:relative;border-radius:1rem;overflow:hidden;margin-bottom:0.75rem;">
                                <img src="<?= htmlspecialchars($image['image_path']) ?>" alt="<?= htmlspecialchars($image['title']) ?>" style="width:100%;height:160px;object-fit:cover;">
