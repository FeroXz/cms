...
function ensure_default_settings(PDO $pdo): void
{
    $defaults = [
        ...
        'footer_text' => '© ' . date('Y') . ' FeroxZ CMS — Version 3.3',
    ...
    if (strpos($currentFooter, 'Version 3.2') !== false) {
        set_setting($pdo, 'footer_text', str_replace('Version 3.2', 'Version 3.3', $currentFooter));
    }
}
