...
function ensure_default_settings(PDO $pdo): void
{
    $defaults = [
        ...
        'footer_text' => '© ' . date('Y') . ' FeroxZ CMS — Version 3.6',
    ...
    if (strpos($currentFooter, 'Version 3.6') === false) {
        if (strpos($currentFooter, 'Version 3.5') !== false) {
            set_setting($pdo, 'footer_text', str_replace('Version 3.5', 'Version 3.6', $currentFooter));
        } elseif (strpos($currentFooter, 'Version 3.4') !== false) {
            set_setting($pdo, 'footer_text', str_replace('Version 3.4', 'Version 3.6', $currentFooter));
        } elseif (strpos($currentFooter, 'Version 3.3') !== false) {
            set_setting($pdo, 'footer_text', str_replace('Version 3.3', 'Version 3.6', $currentFooter));
        } elseif (strpos($currentFooter, 'Version 3.2') !== false) {
            set_setting($pdo, 'footer_text', str_replace('Version 3.2', 'Version 3.6', $currentFooter));
        }
    }
}
